...
protocol CatBreedsServiceProtocol {
    func fetchCatBreedsFromJson() -> Observable<[Breed]>
}

class CatBreedService : CatBreedsServiceProtocol {
    func fetchCatBreedsFromJson() -> Observable<[Breed]> {
    ...
    func fetchBreedsFromApi() -> Observable<[Breed]> {
